...
void D3D12HelloTriangle::CreateShaderBindingTable() {
  ...
  // #DXR Extra - Another ray type
  m_sbtHelper.AddHitGroup(L"PlaneHitGroup", { (void*)(m_perInstanceConstantBuffers[0]->GetGPUVirtualAddress()), heapPointer }); // TODO added this and commented the one above
  // #DXR Extra - Another ray type
  m_sbtHelper.AddHitGroup(L"ShadowHitGroup", {});
